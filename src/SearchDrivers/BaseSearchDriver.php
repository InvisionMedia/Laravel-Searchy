...
abstract class BaseSearchDriver implements SearchDriverInterface
{
	 ...
	 */
	public function __construct($connection = null, $pdo = null, $table = null, $searchFields = [], $relevanceFieldName, $columns = ['*'])
	{
	...
	{
		$pdo = $this->pdo === null ? $this->connection->getPdo() : $this->pdo;

		$this->searchString = substr($pdo->quote($searchString), 1, -1);
